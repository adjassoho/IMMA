...
const About: React.FC = () => {
  return (
    <motion.section
      ...
      className="w-full py-24 px-2 sm:px-8 bg-white flex flex-col items-center justify-center min-h-[60vh]"
    >
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-16">
        {/* Colonne gauche */}
        <div>
          <h2 className="text-3xl md:text-4xl font-extrabold uppercase mb-6 text-primary tracking-wide">NEXO IMMO : LE LIEN IMMOBILIER</h2>
        ...
        {/* Colonne droite */}
        <div>
          <h2 className="text-3xl md:text-4xl font-extrabold uppercase mb-6 text-primary tracking-wide">UN SERVICE IMMOBILIER COMPLET AVEC NEXO IMMO</h2>
